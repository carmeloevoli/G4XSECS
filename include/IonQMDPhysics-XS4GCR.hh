...
// ********************************************************************
//
// $Id: MyIonQMDPhysics.hh 71042 2013-06-10 09:28:44Z gcosmo $
//
//---------------------------------------------------------------------------
//
...
#ifndef MyIonQMDPhysics_h
#define MyIonQMDPhysics_h 1
...
class MyIonQMDPhysics : public G4VPhysicsConstructor {
   public:
    MyIonQMDPhysics(G4int verb = 0);
    MyIonQMDPhysics(const G4String& name, G4int ver = 0);
    virtual ~MyIonQMDPhysics();
   ...
   private:
    void AddProcess(const G4String&, G4ParticleDefinition*,
                    G4BinaryLightIonReaction*, G4QMDReaction*,
