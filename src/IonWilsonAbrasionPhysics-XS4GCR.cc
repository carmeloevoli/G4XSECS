...
// - 1 GeV per nucleon) can be activate. This class can be used alternatively to
// the "binary_ion" physics list
//
// The usefullness of this class is that you can explicitally see the total
// inelastic sections activated and the models called. Moreover you can choose
// to activate for ions (from deuteron to heavier nucleus) three different and
// exclusive models: the Binary Light Ion cascade, the QMD and The Wilson.

// For hadrotherapy pouposes, where distributions of produced fragments is
// importante we strongly suggest to use Binary or QMD. The Binary model is the
// default and at moment, you can swith beetween models decommenting the line of
// code and recompiling

#include "IonWilsonAbrasionPhysics-XS4GCR.hh"
...
/////////////////////////////////////////////////////////////////////////////
MyIonWilsonAbrasionPhysics::MyIonWilsonAbrasionPhysics(const G4String& name)
...
/////////////////////////////////////////////////////////////////////////////
MyIonWilsonAbrasionPhysics::~MyIonWilsonAbrasionPhysics() {}

/////////////////////////////////////////////////////////////////////////////
void MyIonWilsonAbrasionPhysics::ConstructProcess() {
    ...
    //  WilsonModel -> GetExcitationHandler() -> SetPhotonEvaporation(new
    //  G4PhotonEvaporation()); WilsonModel -> SetUseAblation(false);
